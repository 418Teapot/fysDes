...
#include <Tone.h>
#include <IRremote.h>
//Pin 6 is used for piezo buzzer.
//Pin 5 is used for IR transmitter.
//A1 is used for pressure plate.
...
// 4, 5, 7, 8, 9 , 15, A0, 14, 16, 10 };   //remap
   4, 9, 7, 8, 10, 15, A0, 14, 16, 3 };    //final version
...
void shoot () {
 ...
 irsend.sendSony(0xFFFFFF,32); //8 bits
